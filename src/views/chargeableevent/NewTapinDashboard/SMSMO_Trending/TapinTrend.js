...
class TapinTrend extends Component {
    ...
    componentDidMount() {
        const url = 'http://localhost:8080/ChargeableEventGeneration/tapin/smsmotrendanalysis';
        axios.get(url).then((response) => {
            ...
            response.data.map((dat) => {
                data1.push(dat['SMSMOCOUNT']);
                data2.push(dat['maxSMSMOTOTALSDR']);
                label.push(dat['_id']);
            });
            ...
            >
                ...
                <LineChart
                    option={{
                        ...
                        //   },
                        legend: {
                            data: ['Max SMSMO Count', 'Max SMSMO Total SDR'],
                            orient: 'vertical',
                            top: 18,
                            right: 10
                        },
