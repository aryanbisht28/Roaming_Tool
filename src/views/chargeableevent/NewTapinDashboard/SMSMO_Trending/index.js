...
function Index() {
    ...
    useEffect(() => {
        ...
        const url1 = 'http://localhost:8080/ChargeableEventGeneration/tapin/smsmosummary';
    ...
    const handleCountry = async (event) => {
        ...
        try {
            if (event.target.value === 'clear') {
                ...
                const url = 'http://localhost:8080/ChargeableEventGeneration/tapin/smsmofiltercountry';
    ...
    const handleTadig = async (event) => {
        try {
            ...
            const url = 'http://localhost:8080/ChargeableEventGeneration/tapin/smsmofiltertadig';
            const { data: res } = await axios.post(url, data);
