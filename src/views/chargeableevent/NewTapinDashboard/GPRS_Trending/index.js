...
function Index() {
    ...
    useEffect(() => {
        ...
        const url1 = 'http://localhost:8080/ChargeableEventGeneration/tapin/gprssummary';
        axios.get(url1).then((response) => {
            // console.log('Get req', response.data[0], response.data[1]);
            setgprssummary(response.data);
        });
    }, []);
    ...
    const handleCountry = async (event) => {
        ...
        try {
            if (event.target.value === 'clear') {
                ...
                const url = 'http://localhost:8080/ChargeableEventGeneration/tapin/gprsfiltercountry';
    ...
    const handleTadig = async (event) => {
        try {
            ...
            const url = 'http://localhost:8080/ChargeableEventGeneration/tapin/gprsfiltertadig';
            const { data: res } = await axios.post(url, data);
    ...
    function CustomMultipleInput({ onFocus, value }) {
        console.log('dates', onFocus);
        setDate(value);
        return <input onFocus={onFocus} value={date} readOnly />;
    }
        ...
        <Grid container spacing={gridSpacing} xs={12}>
            <Grid container spacing={gridSpacing} sx={{ mt: 1, ml: 0 }} xs={12}>
                <Grid item xs={4}>
                    ...
                    >
                        <h3 style={{ margin: '0.2rem' }}>GPRS Count</h3>
                        <div
                            style={{
                                width: '95%',
                                height: '1.5px',
                        ...
                        >
                            ...
                            <h4>{Object.keys(gprssummary).length != 0 ? gprssummary['GPRSCOUNT'][0]['GPRSCOUNT'] : '0'}</h4>
                        </div>
                    </Card>
                </Grid>
                <Grid item xs={4}>
                    ...
                    >
                        <h3 style={{ margin: '0.2rem' }}>GPRS Total SDR</h3>
                        <div
                            style={{
                                width: '95%',
                                height: '1.5px',
                        ...
                        >
                            ...
                            <h4>{Object.keys(gprssummary).length != 0 ? gprssummary['gprstotalsdr'][0]['totalduration'] : '0'}</h4>
                        </div>
                    </Card>
                </Grid>
                <Grid item xs={4}>
            ...
            <Grid container spacing={gridSpacing} xs={12} sx={{ mt: -2, ml: 0 }}>
                <Grid item xs={4}>
                    ...
                    >
                        <h3 style={{ margin: '0.2rem' }}>GPRS Actual Volume</h3>
                        <div
                            style={{
                                width: '95%',
                                height: '1.5px',
                        ...
                        >
                            ...
                            <h4>{Object.keys(gprssummary).length != 0 ? gprssummary['gprsactualduration'][0]['totalduration'] : '0'}</h4>
                        </div>
                    </Card>
                </Grid>
                <Grid item xs={4}>
                    ...
                    >
                        ...
                        >
                            ...
                            <h4>{Object.keys(gprssummary).length != 0 ? gprssummary['tap'] : '0'}</h4>
                        </div>
                    </Card>
                </Grid>
                <Grid item xs={4}>
