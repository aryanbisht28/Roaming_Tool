...
function Index() {
    ...
    useEffect(() => {
        ...
        const url1 = 'http://localhost:8080/ChargeableEventGeneration/tapin/mtcsummary';
    ...
    const handleCountry = async (event) => {
        ...
        try {
            if (event.target.value === 'clear') {
                ...
                const url = 'http://localhost:8080/ChargeableEventGeneration/tapin/mtcfiltercountry';
    ...
    const handleTadig = async (event) => {
        try {
            ...
            const url = 'http://localhost:8080/ChargeableEventGeneration/tapin/mtcfiltertadig';
            const { data: res } = await axios.post(url, data);
