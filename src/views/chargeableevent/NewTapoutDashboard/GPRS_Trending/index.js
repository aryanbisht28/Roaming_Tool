...
function Index() {
    ...
    useEffect(() => {
        ...
        const url1 = 'http://localhost:8080/ChargeableEventGeneration/gprssummary';
    ...
    const handleCountry = async (event) => {
        ...
        try {
            if (event.target.value === 'clear') {
                ...
                const url = 'http://localhost:8080/ChargeableEventGeneration/gprsfiltercountry';
    ...
    const handleTadig = async (event) => {
        try {
            ...
            const url = 'http://localhost:8080/ChargeableEventGeneration/gprsfiltertadig';
            const { data: res } = await axios.post(url, data);
