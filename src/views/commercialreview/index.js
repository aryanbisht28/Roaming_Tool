...
function Index() {
    ...
    return (
        <div style={{ marginTop: '-90px' }}>
            <Header title={'Commercial Review'} subtitle={'Add'} />
                ...
                <Grid container spacing={gridSpacing}>
                    <Grid item xs={12} md={8}>
                        <fieldset style={{ background: '#ffff' }}>
                            ...
                            <Grid container spacing={gridSpacing} style={{ marginTop: '0.5em' }}>
                            ...
                            <Grid container spacing={gridSpacing} style={{ marginTop: '0.5em' }}>
                                    ...
                                    <Stack direction="row" alignItems="center" spacing={2}>
                                        <Button
                                            ...
                                            style={{
                                                ...
                                                backgroundColor: active1 ? '#757ce8' : '#f8fafc',
                                                color: active1 ? 'white' : '#75808f',
                                                border: 'solid',
                                                borderWidth: '2px',
                                                borderColor: '#00338D',
                                        ...
                                        >
                                            <FileUploadOutlinedIcon /> Upload AA12*
                                ...
                                <Grid item xs={12} md={6}>
                                    <Stack direction="row" alignItems="center" spacing={2}>
                                        ...
                                        >
                                            <FileUploadOutlinedIcon /> Upload AA13*
                            ...
                            <Grid container spacing={gridSpacing} style={{ marginTop: '0.5rem' }}>
                                <Grid item xs={12} md={6}>
                                    <Stack direction="row" alignItems="center" spacing={2}>
                                        <Button
                                            variant="contained"
                                        ...
                                        >
                                            <FileUploadOutlinedIcon /> Upload AA14*
                                ...
                                <Grid item xs={12} md={6}>
                                    <Stack direction="row" alignItems="center" spacing={2}>
                                        ...
                                        >
                                            <FileUploadOutlinedIcon /> Upload IR21*
                    ...
                    <Grid item xs={12} md={4}>
                        <fieldset style={{ background: '#ffff' }}>
                            ...
                            <Grid container spacing={gridSpacing} style={{ marginTop: '1em', marginBottom: '1em', marginRight: '1em' }}>
                                <Grid item xs={12} md={6}>
                                    <FormControlLabel
                                        control={
                                            <Checkbox
            ...
            {/* <AddSPOCTable /> */}
            <fieldset style={{ background: '#ffff', marginTop: '1em' }}>
                ...
                <Grid item xs={12} md={8}>
                    <form onSubmit={handleSubmit}>
                        <Grid container spacing={gridSpacing} style={{ margin: '1rem' }}>
                            ...
                            <Grid item xs={2.4}>
                                <Button type="submit" variant="contained" style={{ background: '#75CFF0' }}>
                                    Add Data
                                </Button>
                            </Grid>
                        </Grid>
            ...
            <Button
                ...
                style={{ position: 'relative', left: 'calc(100% - 80px)', marginTop: '0.7rem', background: '#00338D', color: 'white' }}
