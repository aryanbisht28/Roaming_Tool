...
const names = ['GSM', 'GPRS', '3G', 'CAMEL', 'LTE', 'VoLTE', '5G'];
...
function Index() {
    ...
    React.useEffect(() => {
        const url = 'http://localhost:8080/ppini/subs';
    ...
    return (
        <>
            <div style={{ marginTop: '-90px' }}>
                <Header title={'Subscriber Provisioning'} subtitle={'Launch CLL'} />
                        ...
                        <Grid item xs={12}>
                            <Grid container spacing={gridSpacing}>
                                ...
                                >
                                    ...
                                    >
                                        <FileUploadOutlinedIcon /> Upload CLL*
                                        <input hidden accept="application/" multiple type="file" name="CLL" onChange={handleFile} />
                                    </Button>
                                </Grid>
                            </Grid>
                        </Grid>
